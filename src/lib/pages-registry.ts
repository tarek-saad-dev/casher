...
export const SYSTEM_PAGES: PageDefinition[] = [
  ...
  { key: 'reports.partners_overrides', name: 'الطبقة المتوسطة', path: '/admin/reports/partners-overrides', section: 'الإدارة', accessMode: 'roles', sort: 1005,  defaultRoles: ['super_admin','admin'] },
