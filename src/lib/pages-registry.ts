...
export const SYSTEM_PAGES: PageDefinition[] = [
  ...
  { key: 'admin.payment_methods',   name: 'طرق الدفع',               path: '/admin/payment-methods',           section: 'الإدارة',           accessMode: 'roles', sort: 104, defaultRoles: ['super_admin','admin'] },
  { key: 'admin.categories',        name: 'التصنيفات',               path: '/admin/categories',                section: 'الإدارة',           accessMode: 'roles', sort: 105, defaultRoles: ['super_admin','admin'] },
  { key: 'admin.loyalty',           name: 'إدارة النقاط',            path: '/admin/loyalty',                   section: 'الإدارة',           accessMode: 'roles', sort: 106, defaultRoles: ['super_admin','admin'] },
  { key: 'admin.shift',             name: 'الورديات',                path: '/admin/shift',                     section: 'الإدارة',           accessMode: 'roles', sort: 107, defaultRoles: ['super_admin','admin'] },
  { key: 'admin.settings',          name: 'الإعدادات',               path: '/admin/settings',                  section: 'الإدارة',           accessMode: 'roles', sort: 108, defaultRoles: ['super_admin','admin'] },
  { key: 'admin.queue_settings',    name: 'إعدادات الطابور',         path: '/admin/queue-booking-settings',    section: 'الإدارة',           accessMode: 'roles', sort: 109, defaultRoles: ['super_admin','admin'] },
  // ── Special ──────────────────────────────────────────────────────────────────
