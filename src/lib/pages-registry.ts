...
export const SYSTEM_PAGES: PageDefinition[] = [
  ...
  { key: 'reports.partners_overrides', name: 'تعديل', path: '/admin/reports/partners-overrides', section: 'الإدارة', accessMode: 'roles', sort: 1005,  defaultRoles: ['super_admin','admin'] },
  ...
  { key: 'hr.branch_transfer',      name: 'نقل موظف بين الفروع',     path: '/admin/hr/branch-transfer',        section: 'الموارد البشرية',   accessMode: 'roles', sort: 915, defaultRoles: ['super_admin','admin','manager'] },
  { key: 'hr.employee_monthly_sheet', name: 'تقرير الموظف الشهري',   path: '/admin/hr?tab=employee-monthly-sheet', section: 'الموارد البشرية',   accessMode: 'roles', sort: 916, defaultRoles: ['super_admin','admin','manager'] },
  ...
  { key: 'admin.packages',          name: 'الباكدجات',               path: '/admin/packages',                  section: 'الإدارة',           accessMode: 'roles', sort: 104, defaultRoles: ['super_admin','admin'] },
  { key: 'admin.payment_methods',   name: 'طرق الدفع',               path: '/admin/payment-methods',           section: 'الإدارة',           accessMode: 'roles', sort: 105, defaultRoles: ['super_admin','admin'] },
  { key: 'admin.categories',        name: 'التصنيفات',               path: '/admin/categories',                section: 'الإدارة',           accessMode: 'roles', sort: 106, defaultRoles: ['super_admin','admin'] },
  ...
  { key: 'admin_approvals',         name: 'سجل التدقيق',              path: '/admin/approvals',                 section: 'الإدارة',           accessMode: 'super_admin_only', sort: 202 },
];
