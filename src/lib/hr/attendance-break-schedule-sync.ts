 ...
 *
 * Tags:
 * - Overrides CreatedBy: "attendance-break" | "schedule-control block_range"
...
/**
 * HR → Ops: rebuild synced block_range overrides to match attendance breaks.
 * Non-synced overrides (other CreatedBy) are left alone.
 */
