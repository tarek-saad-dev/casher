...
/** Vercel cron fires at 23:00 UTC ≈ 02:00 Africa/Cairo (IANA offset). */
...
export const NIGHTLY_CLOSE_WATCH_WINDOW_END_MINUTE = 5;
...
/** True when Cairo clock is in the 02:00 fire minute. */
...
/** True when Cairo clock is inside the local watcher forgiving window (02:00–02:05). */
