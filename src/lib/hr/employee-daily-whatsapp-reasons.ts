...
export const DAILY_WA_REASON_AR: Record<string, string> = {
  ...
  development_only:
    'تكامل واتساب مقفول — لازم WHATSAPP_INTEGRATION_ENABLED=true',
  ...
  timeout: 'انتهت مهلة الاتصال ببوت الواتساب على :3001',
  connection_failed: 'مفيش اتصال ببوت الواتساب — هل http://127.0.0.1:3001 شغّال؟',
