...
export const BRANCH_OWNED_ROUTE_MARKERS = [
  ...
  { path: 'src/app/api/shifts/route.ts', mustContain: 'BranchID = @branchId' },
  { path: 'src/app/api/business-days/route.ts', mustContain: 'BranchID = @branchId' },
  { path: 'src/app/api/treasury/daily-summary/route.ts', mustContain: 'appendTreasuryCashMoveFilters' },
  { path: 'src/app/api/treasury/movements/route.ts', mustContain: 'appendTreasuryCashMoveFilters' },
  { path: 'src/app/api/treasury/hold-breakdown/route.ts', mustContain: 'appendTreasuryCashMoveFilters' },
