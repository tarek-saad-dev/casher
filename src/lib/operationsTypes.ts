...
export interface QueueTicket {
  ...
  BookingID: number | null; // If set, this ticket is linked to a booking
  QueueDate: string;
  CreatedTime: string;
  Status: QueueStatus;
  Priority: number; // 0=walk_in, 1=reserved_booking, 2=manual_priority
  Notes: string | null;
...
// PriorityType concept:
// - walk_in (0): Standard walk-in customer
// - reserved_booking (1): Customer with a confirmed booking
// - manual_priority (2): Manager override / urgent case
