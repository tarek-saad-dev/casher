  ...
  return (
    <section className="w-full min-w-0 bg-zinc-900/50 border border-zinc-800/50 rounded-xl p-3 sm:p-4 md:p-6 print:break-inside-avoid print:bg-white print:border-zinc-300">
      ...
      filteredOperatingExpenses === 0 ? (
        ...
        <div className="operating-net-flow financial-flow flex flex-col md:flex-row md:items-center md:justify-center gap-3 sm:gap-4 md:gap-3 w-full min-w-0">
          <div className="revenue-card flex-1 min-w-0 rounded-xl border border-emerald-500/25 bg-emerald-500/5 px-3 py-3 sm:px-5 sm:py-4 text-center print:border-emerald-700 print:bg-emerald-50">
          ...
          <div className="expenses-card flex-1 min-w-0 rounded-xl border border-rose-500/25 bg-rose-500/5 px-3 py-3 sm:px-5 sm:py-4 text-center print:border-rose-700 print:bg-rose-50">
            <span className="block text-xs sm:text-sm text-zinc-400 print:text-zinc-600 mb-1.5 sm:mb-2">
              مصروفات التشغيل الأخرى
            </span>
            <strong className="text-lg sm:text-xl md:text-2xl font-bold text-rose-400 print:text-rose-700 tabular-nums">
          ...
          <div
            className={`result-card flex-[1.2] min-w-0 rounded-xl border px-3 py-4 sm:px-5 sm:py-5 text-center print:border-zinc-400 ${
              isNegative
