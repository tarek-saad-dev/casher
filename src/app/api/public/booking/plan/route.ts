    ...
    return finalizePublicBookingJson(
      ...
      gate,
      {
        ...
        plan: {
          ...
          package: evaluation.packageBooking
            ? {
                packageId: evaluation.packageBooking.packageId,
                nameEn: evaluation.packageBooking.nameEn,
                nameAr: evaluation.packageBooking.nameAr,
                packagePrice: evaluation.packageBooking.packagePrice,
                requiredServiceIds: evaluation.packageBooking.requiredServiceIds,
                addonProIds: evaluation.packageBooking.addonProIds,
                addonPrices: evaluation.packageBooking.addonLines.map((a) => ({
                ...
                addonTotal: evaluation.packageBooking.addonTotal,
                durationMinutes: evaluation.packageBooking.totalDurationMinutes,
                total: evaluation.packageBooking.totalPrice,
                clientServiceIdsMismatch: evaluation.packageBooking.clientServiceIdsMismatch,
              }
            : null,
