...
import { generateReferralCode, generateReferralShareUrl } from '@/lib/loyalty/helpers';
 ...
 */
export async function GET(req: NextRequest): Promise<NextResponse<ClientReferralResponse | LoyaltyErrorResponse>> {
  try {
