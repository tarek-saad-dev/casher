...
import { applyEmployeePayrollGapDay } from '@/lib/hr/employeePayrollGapReview';
...
/**
 * POST /api/admin/hr/payroll-gap-review/generate-day
...
export async function POST(req: NextRequest) {
  try {
    ...
    const result = await applyEmployeePayrollGapDay({
      empId,
      branchId,
      year,
      month,
    ...
    console.error('[api/admin/hr/payroll-gap-review/generate-day] POST error:', message);
